...
ActiveRecord::Schema.define(version: 20180119083020) do
  ...
  create_table "entry_enclosures", force: :cascade do |t|
    ...
    t.index ["entry_id"], name: "index_entry_enclosures_on_entry_id", using: :btree
  end
  ...
  create_table "liked_entries", force: :cascade do |t|
    t.uuid     "user_id",    null: false
    t.string   "entry_id",   null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "entry_id"], name: "index_liked_entries_on_user_id_and_entry_id", unique: true, using: :btree
  end
